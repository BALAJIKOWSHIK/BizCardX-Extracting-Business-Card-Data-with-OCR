...
selected = option_menu(None, ["Home", "Upload", "Delete","Creator"],
                       icons=["house", "cloud-upload", "trash","person-circle"],
                       default_index=2,
...
if selected=="Creator":
    ...
    with col3:
     ...
     col3.markdown("### :red[GITHUB URL] : ***https://github.com/BALAJIKOWSHIK***")
     col3.markdown('### :red[ ***Data Scientist Aspirant***]')
    st.write("--------------------------")
    st.image(image)